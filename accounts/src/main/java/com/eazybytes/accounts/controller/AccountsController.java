...
@Validated //This says to spring boot that to perform validation on this class and all mentioned rest api's inside it.
public class AccountsController {
    ...
    @RequestMapping(value = "/java-version", method = RequestMethod.GET)
